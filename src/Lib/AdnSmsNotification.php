...
namespace DoText\LaravelAdnSms\Lib;
...
class AdnSmsNotification extends AbstractAdnSms
{
    ...
    {
        $this->config = include(__DIR__ . '/../config/adn.php');
    ...
    public function sendSms($message, $recipient, $requestType = 'SINGLE_SMS', $messageType = 'TEXT', $campaignTitle = null)
    {
    ...
    public function sendBulkSms($message, $recipient, $campaignTitle, $messageType = 'TEXT')
    {
        $this->setApiUrl($this->config['apiUrl']['send_sms']);
    ...
    public function multibodyCampaign($smsArray, $messageType = 'TEXT', $campaignTitle = null)
    {
        $this->setApiUrl($this->config['apiUrl']['send_sms']);
